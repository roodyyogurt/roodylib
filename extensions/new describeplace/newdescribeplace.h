...
things and add a little more functionality. If you include this file, though,
you get the much larger DescribePlace version that allows
...
Setting DESCFORM_F will "double
...
#ifclear _NEWDESCRIBEPLACE_H
#set _NEWDESCRIBEPLACE_H
				...
				if not no_good
				{
					...
					if good
					{
						if count++
							...
							Indent
						RLibMessage(&DescribePlace,1, i) ! "The <blank> you are
...
! WhatsIn is replaced just to add some code to support the
! "double-spaced" DESCFORM_F format
